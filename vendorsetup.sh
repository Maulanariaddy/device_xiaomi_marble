...
echo 'Cloning Device Common Tree'
	git clone https://github.com/Maulanariaddy/device_xiaomi_marble_sm8450_common.git device/xiaomi/sm8450-common
...
echo 'Cloning Hardware Xiaomi Tree'
	git clone https://github.com/Maulanariaddy/hardware_xiaomi.git hardware/xiaomi

echo 'Cloning Kernel Tree'
	git clone https://github.com/marble-indonesia/device_xiaomi_marble-kernel.git device/xiaomi/marble-kernel

echo 'Cloning Vendor Tree'
	git clone https://github.com/Maulanariaddy/vendor_xiaomi_marble.git vendor/xiaomi/marble
